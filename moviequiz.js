...
function checkAnswer(element) {
    ...
    if(chosenAnswer == correctChoices[currentQuestion]) {
        ...
        answerIndicator.style.color = "lightgreen";
        points++;
...
function moveToNextQuestion() {
    if(currentQuestion < (movieQuotes.length - 1)) {
        ...
        document.getElementById("QuestionHeader").innerHTML = "Quote " + (currentQuestion + 1);
        ...
        let scoreURL = "./end.html?score=" + score.toString();
        console.log(scoreURL);
        document.getElementById("SeeScore").innerHTML = "Click <a href = " + scoreURL + ">Here</a> To See Your Score";
    }
